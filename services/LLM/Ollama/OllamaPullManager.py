...
class OllamaPullManager:
    ...
    def pull_model(self) -> None:
        ...
        if flag:
            print_info(f"Model {self.model_name} is available on the server.")
            return
        
        print_info(f"Pulling model {self.model_name} in {self.mode} mode...")
    ...
    def _fall_back_intervention(self):
        ...
        """
        print_info(f"Starting final download attempt with {self.fall_back_interval}s interventions...")
        max_attempts = 10
