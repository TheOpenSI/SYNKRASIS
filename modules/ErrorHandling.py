...
class ErrorHandling():
    ...
    def get_error_type(error_message: str) -> str:
        ...
        ** Must remove the experiemental error message if present.
        ...
        - str: The error type.
        """
        e_m = ErrorHandling.remove_multithred_generic_error(error_message)
    ...
    def assertion_error_prompt(self, error_message: str,  
        ...
        if extract_test_case:
            test_case = self._get_test_case(error_message, change_test_case_entry, to_replace, entry_point)
            return (f"Your generated code failed the following test case - {test_case}. "
                    "Please update the function logic so all test cases can pass. Error message added for your reference.\n"
                    f"{error_message}")
        else:
    ...
    def name_error_prompt(self, error_message: str) -> str:
        ...
        Please check the function, varibale names and make sure they are same as instruction.
        {error_message}
    ...
    def generic_error_prompt(self, error_message: str) -> str:
        """
