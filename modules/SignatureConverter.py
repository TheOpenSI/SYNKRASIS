# =====================================================================================================
# Module for converting a given function call into function signature.
# All static methods.
# Example: SignatureConverter.convert("foo(4, 5)") -> foo(arg_int: int, arg_int_2: int)
# Usage:
#     - convert(call_string: str) -> str: Convert a function call string into its signature with argument types.
#     - sanitise_variable_name(name: str) -> str: Fixes a string to make it a valid Python variable name.
#     - parse_function_call(call_string: str) -> Tuple[str, List[str]]: Parse a function call string to 
#       extract the function name and arguments as strings.
